...
Augustine says (De Trin. vii, 11): "As the Son is related to the Father, so also is the Word to Him Whose Word He is." But the Son is a personal name, since it is said relatively. Therefore so also is Word.
